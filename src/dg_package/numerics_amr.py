...
#     print(f'stages = {stages}')
    ...
    while (time < time_final):
        ...
        #   refs,defs,marks = mark(active, label_mat, info_mat, coord, intma, level, max_level, qe)  # exact solution
          refs,defs,marks = mark(active, label_mat, info_mat, coord, intma, level, max_level, qp)  # comuted
          print(f'\ntimestep: {anim}\n active: {active}\n marks: {marks}\n refs: {refs}\n defs:{defs}')
          # print(f'refs: {refs}')
          # print(f'defs: {defs}')
          ...
          #now scatter and gather solutions.
